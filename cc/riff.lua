...
-- "Created" for use in the MCA library
...
-- while we're messing around in Blob.types let's add more
-- these types should really be in Blob.lua but since they aren't
-- and I don't feel like locking you into my version of Blob I'm
-- gonna declare them here
Blob.types.uint32 = "I4"
Blob.types.uint16 = "I2"
Blob.types.uint8 = "I1"
Blob.types.int32 = "i4"
Blob.types.int16 = "i2"
Blob.types.int8 = "i1"
